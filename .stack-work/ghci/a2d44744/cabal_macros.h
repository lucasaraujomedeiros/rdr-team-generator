...
#endif /* VERSION_rdr_team_generator */
#ifndef MIN_VERSION_rdr_team_generator
#define MIN_VERSION_rdr_team_generator(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_rdr_team_generator */
